...
__C.TRAIN.LOG_DIR = '/opt/data/private/PHFP/logs'

__C.TRAIN.SNAPSHOT_DIR = '/opt/data/private/PHFP/snapshot'
...
__C.DATASET.NAMES = ("COCO", "GOT", "LaSOT")


__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = "/opt/data/private/data/coco/crop511"
__C.DATASET.COCO.ANNO = "/opt/data/private/data/coco/train2017.json"
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1


__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = "/opt/data/private/data/got10k/crop511" 
__C.DATASET.GOT.ANNO = "/opt/data/private/data/got10k/train.json"
...
__C.DATASET.LaSOT.ROOT = (
    "/opt/data/private/data/LaSot/crop511"  
)
__C.DATASET.LaSOT.ANNO = "/opt/data/private/data/LaSot/train.json"
