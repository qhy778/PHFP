...
from pysot.tracker.phfp_tracker import PHFP
...
def main():
    parser = argparse.ArgumentParser(description="-PHFP tracking")
    parser.add_argument("--dataset", default="UAVTrack112", type=str, help="datasets"),
    parser.add_argument(
        "--dataset-root", default="./dataset", type=str, help="dataset root"
    )
    parser.add_argument(
