...
sys.path.append("/opt/data/private/PHFP/")

from tqdm import tqdm
from multiprocessing import Pool

from tools.draw_success_precision import draw_success_precision
...
parser.add_argument(
    "--datasetpath",
    default="/opt/data/private/test_datasets/",
    type=str,
...
parser.add_argument("--tracker_path", default="/opt/data/private/PHFP/results/", type=str)
